        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consults_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contract_AspNetUsers_ClientId1",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TechnicianID = table.Column<string>(nullable: false),
                    RoleWorkerID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkersWithRole", x => new { x.RoleWorkerID, x.TechnicianID });
                    table.ForeignKey(
                        name: "FK_WorkersWithRole_RoleWorker_RoleWorkerID",
                        column: x => x.RoleWorkerID,
                        principalTable: "RoleWorker",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkersWithRole_AspNetUsers_TechnicianID",
                        column: x => x.TechnicianID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consults_AdminId",
                table: "Consults",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Contract_AdminId",
                table: "Contract",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Contract_ClientId1",
                table: "Contract",
                column: "ClientId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkersWithRole_TechnicianID",
                table: "WorkersWithRole",
                column: "TechnicianID");
        }
